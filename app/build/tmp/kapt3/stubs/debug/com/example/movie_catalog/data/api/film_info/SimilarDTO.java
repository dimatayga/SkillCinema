...
public final class SimilarDTO {
    ...
    public final com.example.movie_catalog.data.api.film_info.SimilarDTO copy(@org.jetbrains.annotations.Nullable
    ...
    public SimilarDTO(@org.jetbrains.annotations.Nullable
    @com.squareup.moshi.Json(name = "total")
    java.lang.Integer total, @org.jetbrains.annotations.Nullable
    @com.squareup.moshi.Json(name = "items")
    java.util.List<com.example.movie_catalog.data.api.film_info.SimilarItemDTO> items) {
