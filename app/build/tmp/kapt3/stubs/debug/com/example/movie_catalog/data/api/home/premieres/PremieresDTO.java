...
public final class PremieresDTO {
    ...
    public PremieresDTO(@com.squareup.moshi.Json(name = "total")
    @org.jetbrains.annotations.Nullable()
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.example.movie_catalog.data.api.home.premieres.PremieresDTO copy(@com.squareup.moshi.Json(name = "total")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer total, @com.squareup.moshi.Json(name = "items")
    @org.jetbrains.annotations.NotNull()
    java.util.List<com.example.movie_catalog.data.api.home.premieres.FilmDTO> items) {
