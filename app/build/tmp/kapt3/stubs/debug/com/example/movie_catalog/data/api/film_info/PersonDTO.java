...
public final class PersonDTO implements android.os.Parcelable {
    ...
    public PersonDTO(@com.squareup.moshi.Json(name = "staffId")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer staffId, @com.squareup.moshi.Json(name = "nameRu")
    @org.jetbrains.annotations.Nullable()
    java.lang.String nameRu, @com.squareup.moshi.Json(name = "nameEn")
    @org.jetbrains.annotations.Nullable()
    java.lang.String nameEn, @com.squareup.moshi.Json(name = "description")
    @org.jetbrains.annotations.Nullable()
    java.lang.String description, @com.squareup.moshi.Json(name = "posterUrl")
    @org.jetbrains.annotations.Nullable()
    java.lang.String posterUrl, @com.squareup.moshi.Json(name = "professionText")
    @org.jetbrains.annotations.Nullable()
    java.lang.String professionText, @com.squareup.moshi.Json(name = "professionKey")
    @org.jetbrains.annotations.Nullable()
    ...
    public final com.example.movie_catalog.data.api.film_info.PersonDTO copy(@com.squareup.moshi.Json(name = "staffId")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer staffId, @com.squareup.moshi.Json(name = "nameRu")
    @org.jetbrains.annotations.Nullable()
    java.lang.String nameRu, @com.squareup.moshi.Json(name = "nameEn")
