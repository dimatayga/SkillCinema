...
public final class FilmImageDTO {
    ...
    public FilmImageDTO(@com.squareup.moshi.Json(name = "total")
    @org.jetbrains.annotations.Nullable()
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.example.movie_catalog.data.api.film_info.FilmImageDTO copy(@com.squareup.moshi.Json(name = "total")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer total, @com.squareup.moshi.Json(name = "totalPages")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer totalPages, @com.squareup.moshi.Json(name = "items")
