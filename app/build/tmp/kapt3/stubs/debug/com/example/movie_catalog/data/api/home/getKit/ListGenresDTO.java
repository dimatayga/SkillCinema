...
public final class ListGenresDTO {
    ...
    public final com.example.movie_catalog.data.api.home.getKit.ListGenresDTO copy(@org.jetbrains.annotations.Nullable
    @com.squareup.moshi.Json(name = "genres")
    java.util.List<com.example.movie_catalog.data.api.home.getKit.GenreIdDTO> genres, @org.jetbrains.annotations.Nullable
    ...
    public ListGenresDTO(@org.jetbrains.annotations.Nullable
    @com.squareup.moshi.Json(name = "genres")
    java.util.List<com.example.movie_catalog.data.api.home.getKit.GenreIdDTO> genres, @org.jetbrains.annotations.Nullable
    @com.squareup.moshi.Json(name = "countries")
    java.util.List<com.example.movie_catalog.data.api.home.getKit.CountryIdDTO> countries) {
