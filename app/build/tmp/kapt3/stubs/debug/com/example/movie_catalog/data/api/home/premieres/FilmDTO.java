...
public final class FilmDTO {
    ...
    public FilmDTO(@com.squareup.moshi.Json(name = "kinopoiskId")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer kinopoiskId, @com.squareup.moshi.Json(name = "nameRu")
    @org.jetbrains.annotations.Nullable()
    java.lang.String nameRu, @com.squareup.moshi.Json(name = "nameEn")
    @org.jetbrains.annotations.Nullable()
    java.lang.String nameEn, @com.squareup.moshi.Json(name = "year")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer year, @com.squareup.moshi.Json(name = "posterUrl")
    @org.jetbrains.annotations.Nullable()
    java.lang.String posterUrl, @com.squareup.moshi.Json(name = "posterUrlPreview")
    @org.jetbrains.annotations.Nullable()
    java.lang.String posterUrlPreview, @com.squareup.moshi.Json(name = "countries")
    @org.jetbrains.annotations.NotNull()
    java.util.List<com.example.movie_catalog.entity.Country> countries, @com.squareup.moshi.Json(name = "genres")
    @org.jetbrains.annotations.NotNull()
    java.util.List<com.example.movie_catalog.entity.Genre> genres, @com.squareup.moshi.Json(name = "duration")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer duration, @com.squareup.moshi.Json(name = "premiereRu")
    @org.jetbrains.annotations.Nullable()
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.example.movie_catalog.data.api.home.premieres.FilmDTO copy(@com.squareup.moshi.Json(name = "kinopoiskId")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer kinopoiskId, @com.squareup.moshi.Json(name = "nameRu")
    @org.jetbrains.annotations.Nullable()
    java.lang.String nameRu, @com.squareup.moshi.Json(name = "nameEn")
