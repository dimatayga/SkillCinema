 ...
 */
public abstract class Hilt_SeasonsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeasonsFragment() {
    super();
  }

  Hilt_SeasonsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeasonsFragment_GeneratedInjector) this.generatedComponent()).injectSeasonsFragment(UnsafeCasts.<SeasonsFragment>unsafeCast(this));
    }
  }
