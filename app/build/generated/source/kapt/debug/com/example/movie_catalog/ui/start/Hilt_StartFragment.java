 ...
 */
public abstract class Hilt_StartFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StartFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartFragment_GeneratedInjector) this.generatedComponent()).injectStartFragment(UnsafeCasts.<StartFragment>unsafeCast(this));
    }
  }
