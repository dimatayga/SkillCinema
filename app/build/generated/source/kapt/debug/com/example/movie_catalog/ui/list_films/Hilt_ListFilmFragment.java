 ...
 */
public abstract class Hilt_ListFilmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListFilmFragment() {
    super();
  }

  Hilt_ListFilmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListFilmFragment_GeneratedInjector) this.generatedComponent()).injectListFilmFragment(UnsafeCasts.<ListFilmFragment>unsafeCast(this));
    }
  }
