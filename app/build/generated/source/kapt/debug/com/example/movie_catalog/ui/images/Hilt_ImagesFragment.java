 ...
 */
public abstract class Hilt_ImagesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImagesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImagesFragment_GeneratedInjector) this.generatedComponent()).injectImagesFragment(UnsafeCasts.<ImagesFragment>unsafeCast(this));
    }
  }
