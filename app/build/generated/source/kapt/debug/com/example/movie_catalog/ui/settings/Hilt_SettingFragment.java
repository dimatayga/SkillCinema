 ...
 */
public abstract class Hilt_SettingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SettingFragment() {
    super();
  }

  Hilt_SettingFragment(int contentLayoutId) {
