 ...
 */
public abstract class Hilt_FilmPageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilmPageFragment() {
    super();
  }

  Hilt_FilmPageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilmPageFragment_GeneratedInjector) this.generatedComponent()).injectFilmPageFragment(UnsafeCasts.<FilmPageFragment>unsafeCast(this));
    }
  }
