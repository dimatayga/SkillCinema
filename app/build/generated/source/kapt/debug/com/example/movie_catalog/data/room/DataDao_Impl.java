...
public final class DataDao_Impl implements DataDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfClearByCollectionIdCrossFC;
  ...
  public DataDao_Impl(RoomDatabase __db) {
    ...
    this.__preparedStmtOfClearByCollectionIdCrossFC = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "DELETE FROM crossFC WHERE collection_id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void clearByCollectionIdCrossFC(final int id) {
    __db.assertNotSuspendingTransaction();
    final SupportSQLiteStatement _stmt = __preparedStmtOfClearByCollectionIdCrossFC.acquire();
    int _argIndex = 1;
    _stmt.bindLong(_argIndex, id);
    __db.beginTransaction();
    try {
      ...
      __db.endTransaction();
      __preparedStmtOfClearByCollectionIdCrossFC.release(_stmt);
    }
  }
  ...
  @Override
  public List<CollectionDB> getCollections() {
