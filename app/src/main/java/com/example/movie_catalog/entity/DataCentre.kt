...
object DataCentre {
    ...
    fun setApiKey() {
        when (headers["X-API-KEY"]) {
            ...
            "20c3f30c-7ba7-4417-9c72-4975ac6091c6" -> headers["X-API-KEY"] =
                "f8b0f389-e491-48d0-8794-240a6d0bc635"

            "f8b0f389-e491-48d0-8794-240a6d0bc635" -> headers["X-API-KEY"] =
                "130f6e6d-9e90-4c52-8cf5-8c4cda072fa8"

            "130f6e6d-9e90-4c52-8cf5-8c4cda072fa8" -> headers["X-API-KEY"] =
